...
function Blog() {
  return (
    <div className="flex flex-col text-white max-w-[1200px] w-full mx-auto md:mt-[40px] h-full">
       <div className="hiden md:flex mx-auto my-auto mt-[24px] max-w-[1200px] h-[241px] justify-center">
          ...
          <div className="hidden md:flex flex-col absolute z-10 text-center mt-[50px]">
            <p className="h-[40px] text-[30px] text-white font-bold tracking-[1px]">
             figa blog
            </p>
            <p className="text-white font-[400] text-[18px] text-transparent leading-[30px] bg-clip-text bg-gradient-to-r from-white to-gray-500 tracking-[1px] mt-[20px]">
        ...
        <div className="">
          <p className="font-[400] text-[18px] text-transparent leading-[30px] bg-clip-text bg-gradient-to-r from-white to-gray-500 tracking-[1px]"></p>
        </div>

      <div className="grid md:grid-cols-3 gap-y-5 gap-x-7 md:mt-[40px] max-w-[1240px]">
        <a href="/blogeticaret">
