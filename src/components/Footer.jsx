...
export default function Footer() {
  return (
    <div className='h-screen flex flex-col justify-center items-center'>
        <h1 className='text-[24px] md:text-[36px] leading-[45px] text-transparent pb-9 text-4xl bg-clip-text bg-gradient-to-r from-white to-content-grey text-center font-[600]'>Sen bana yazıl dedin, ben de yazılımcı oldum ;)</h1>
