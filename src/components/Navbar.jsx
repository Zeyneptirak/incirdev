...
const handleClose=()=> setNav(!nav)
  ...
  return (
    <div name="navbar" className='w-screen h-[80px] z-10 font-sora absolute top-0'> 
        <div className='px-4 md:px-3 flex items-center w-full h-full justify-between'>
            <div className='z-10'>
             <a href='/'> <img className='h-[32px] md:h-[48px] md:ml-16' src={logo} alt="" /> </a>
            </div>
            <div className='items-center hidden md:flex mr-16'>
                <ul className='flex text-[16px] font-[400] z-10'>
                    <li className='cursor-pointer text-white font-[600] tracking-[2px]'><a href='/'>Ana Sayfa</a></li>
                    <li className='cursor-pointer hover:text-white hover:font-[600] text-content-grey tracking-[1px]'><Link to="services" smooth={true} offset={-50} duration={500}>Hizmetlerimiz</Link></li>
                    <li className='cursor-pointer hover:text-white hover:font-[600] text-content-grey tracking-[1px]'><Link to="about" smooth={true} offset={-200} duration={500}>Hakkımızda</Link></li>
                    <li className='cursor-pointer hover:text-white hover:font-[600] text-content-grey tracking-[1px]'><Link to="works" smooth={true} offset={-50} duration={500}>Çalışmalar</Link></li>
                    <li className='cursor-pointer hover:text-white hover:font-[600] text-content-grey tracking-[1px]'><Link to="contact" smooth={true} offset={-170} duration={500}>İletişim</Link></li>
        ...
        <ul className={!nav ? 'hidden' : 'absolute bg-card-bg  font-light w-full x-8 z-11'} >
            ...
            <li className='border-b-2 border-menuLine text-content-grey hover:text-white w-f ull'><Link onClick={handleClose} to="works" smooth={true} offset={-70} duration={500}>Çalışmalar</Link></li>
