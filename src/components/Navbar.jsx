        ...
        <div className='px-4 md:px-3 flex items-center w-full h-full justify-between'>
            ...
            <div className='items-center hidden md:flex mr-16'>
                <ul className='flex text-[16px] font-[400] z-10'>
                    <li className='cursor-pointer text-white font-[600] tracking-[2px]'><Link to="home" smooth={true} duration={500}>Ana Sayfa</Link></li>
                    ...
                    <li className='cursor-pointer hover:text-white hover:font-[600] text-content-grey tracking-[1px]'><Link to="contact" smooth={true} offset={-100} duration={500}>İletişim</Link></li>
                </ul>
